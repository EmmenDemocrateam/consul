...
describe "Tags" do
  ...
  xscenario "Turbolinks sanity check from budget's show" do
  ...
  xscenario "Turbolinks sanity check from budget heading's show" do
    create(:tag, name: "Education", kind: "category")
    create(:tag, name: "Health",    kind: "category")
  ...
  context "Valuation" do
    ...
    xscenario "Valuators do not see user tags", :admin do
      investment = create(:budget_investment, heading: heading, tag_list: "Park")

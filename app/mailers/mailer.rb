class Mailer < ApplicationMailer
  ...
  def budget_investment_unfeasible(investment)
    ...
    with_user(@author) do
      mail(to: @email_to, subject: t("mailers.budget_investment_unfeasible.subject", code: @investment.title))
    end
  end
  ...
  def budget_investment_selected(investment)
    ...
    with_user(@author) do
      mail(to: @email_to, subject: t("mailers.budget_investment_selected.subject", code: @investment.title))
    end
  end
  ...
  def budget_investment_unselected(investment)
    ...
    with_user(@author) do
      mail(to: @email_to, subject: t("mailers.budget_investment_unselected.subject", code: @investment.title))
    end
  end
